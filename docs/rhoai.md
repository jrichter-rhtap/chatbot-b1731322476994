...
3) Access the `workbench` named `chatbot-b1731322476994-notebook`.
...
5) In the terminal, run `cd chatbot-b1731322476994` to navigate to your sample app's directory.
